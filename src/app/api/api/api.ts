...
export const APIS = [AuthenticationControllerService, ConfigurationControllerService, DeviceControllerService, DeviceGroupControllerService, InterfaceControllerService];
